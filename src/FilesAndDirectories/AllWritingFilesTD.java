...
public class AllWritingFilesTD {
	...
	public static void main(String[] args) {
		...
		if (false) {
			...
			AllWritingFiles.writingByteToBinaryWithOutputStream(testPath.resolve("outputStreamAppend.txt"), (byte) -128);
			AllWritingFiles.writingByteToBinaryWithOutputStream(testPath.resolve("outputStreamAppend.txt"), (byte) 12345);
			AllWritingFiles.writingByteToBinaryWithOutputStream(testPath.resolve("outputStreamAppend.txt"), (byte) 127);
		}
		//</editor-fold>
