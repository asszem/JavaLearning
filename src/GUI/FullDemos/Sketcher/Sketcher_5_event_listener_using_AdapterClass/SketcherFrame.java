package GUI.FullDemos.Sketcher.Sketcher_5_event_listener_using_AdapterClass;
...
public class SketcherFrame extends JFrame {
	...
	public SketcherFrame(String title) {
		...
		colorMenu.add(yellowItem = new JCheckBoxMenuItem("Sárga", true));
		colorMenu.add(greenItem = new JCheckBoxMenuItem("Green", false));
		colorMenu.add(blueItem = new JCheckBoxMenuItem("Blue", false));
