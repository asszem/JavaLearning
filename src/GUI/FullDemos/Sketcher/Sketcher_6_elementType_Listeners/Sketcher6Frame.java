...
import static GUI.FullDemos.Sketcher.Sketcher_6_elementType_Listeners.SketcherConstants.*;
import static java.awt.Color.*;														// To use all color names
...
public class Sketcher6Frame extends JFrame {
	...
	public Sketcher6Frame(String title) {
		...
		colorMenu.add(redItem = new JCheckBoxMenuItem("Red", elementColor.equals(RED)));  // Color constant from java.awt.Color
