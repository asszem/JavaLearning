...
public class DrawInJComponent_Collection {
	...
	class innerJComponentView extends JComponent implements Observer, MouseListener {
		...
		public void drawEllipse(Graphics2D context, Point2D.Double start, int width, int height) {
			...
			drawString(context, "Ellipse2D at x="+start.x+" y="+start.y+" w="+width+" h="+height, (int) start.x, (int)( start.y-10));
		...
		public void drawArc(Graphics2D context, Point2D.Double start, int width, int height, int startAngle,
			...
			Arc2D.Double arch2 = new Arc2D.Double(start.x, start.y+100, width, height, startAngle, extendAngle, Arc2D.CHORD);
			Arc2D.Double arch3 = new Arc2D.Double(start.x, start.y+200, width, height, startAngle, extendAngle, Arc2D.PIE);
			drawString(context, "Arch2D "+start.x+","+start.y+" w="+width+" h="+height+" startAngle="+startAngle+" extentAngle="+extendAngle, (int) start.x, (int)( start.y-60));
		...
		public void drawCircle(Graphics2D context, Point2D.Double circleCenter, int radius){
			...
			drawString(context, "Circle from radius="+radius+" at center x="+circleCenter.x+" y="+circleCenter.y, textPos.x, textPos.y);

			Ellipse2D.Double circle = new Ellipse2D.Double(circleCenter.x-radius, circleCenter.y-radius, radius*2, radius*2);
			context.draw(circle);
		}
	...
	public static void main(String[] args) {
		DrawInJComponent_Collection theAppInstance = new DrawInJComponent_Collection();
