 ...
 */
public class UpperLowerBoundedWildcardsInMethodTypeParam {
	...
	public static void main(String[] args) {
		...
		UpperLowerBoundedWildcardsInMethodTypeParam instance = new UpperLowerBoundedWildcardsInMethodTypeParam();
