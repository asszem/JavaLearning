...
Implementation plan
1. The BasicLinkedListAndras class will have a nested class that holds the items of a list object
 ...
 */
public class BasicLinkedListAndras implements Serializable{
