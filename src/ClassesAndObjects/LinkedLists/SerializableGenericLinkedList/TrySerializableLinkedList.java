...
public class TrySerializableLinkedList {
  public static void main(String[] args) {
    ...
    SerializableGenericLinkedList<Integer> numbers = new SerializableGenericLinkedList<>();
    for(int i = 0 ; i < 10 ; ++i) {
    ...
    SerializableGenericLinkedList<Integer> values = null;                                 // Variable to store list from the file
    ...
    try (ObjectInputStream objIn = new ObjectInputStream(new BufferedInputStream(Files.newInputStream(file)))){
      values = (SerializableGenericLinkedList<Integer>)(objIn.readObject()); //Compiler should give warnings here
  ...
  static void listAll(SerializableGenericLinkedList<Integer> list) {
