...
import ClassesAndObjects.Practice.H_Ch05_Classes.Geometry.Line;    // Import the Point and Line classes
import ClassesAndObjects.Practice.H_Ch05_Classes.Geometry.Point;
...
public class TryPackage {
  public static void main(String[] args) {
    ...
    Line[] lines = new Line[points.length - 1]; //A következő vonal az előző pont végéből indul
