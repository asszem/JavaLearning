...
public class SyncMethodsOnSameObject {
	...
	public static void main(String[] args) {
		System.out.println("Running synched methods A and B on same object");
		// Create two objects. The objects are not in a runnable class
		SyncMethodsOnSameObject object1 = new SyncMethodsOnSameObject();
		// Create 3 threads
