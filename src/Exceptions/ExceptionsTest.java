...
public class ExceptionsTest {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			// A konstruktor első argumentuma egy instance paraméter, a második
			// pedig egy Throwable object
		...
		// Metódus hívása, ami ArithmeticException-re saját exceptiont dob
		// vissza, annak saját instance változóival
		...
		try {
			...
			// Vagy a main-hez is hozzá van adva, de ha ott sincs kezelve, akkor
			// build failedlesz.
			osztas2(10, 0);
		} catch (Exception e) {
		...
		System.out.println("\t4. példa");
		/*
		 * //read() method definition in java.io Class throws IOException //so
		 * it must either catched in code or add throws IOException to main
		 * method // int read = System.in.read(); //
		 * System.out.println("Read változó:" + read); //call method with
		 * embedded try-catch-finally blocks osztas(10, 1); osztas(10, 0);
		 * //catch a metóduson kívül try {
		 * System.out.println("try block a main()ben: ");
		 * System.out.println("10/" + (10.0 / osztas(0, 1)) + ""); int[] array =
		 * new int[4]; array[5] = 12; } catch (ArrayIndexOutOfBoundsException e)
		 * {
		 * System.out.println("Array Index Out of Bounds exception a main()-ben"
		 * ); } catch (Exception e) { System.out.println("main() exception" +
		 * e); } //Try outside of for cycle - the cycle stops at the exception
		 * int i = 10; try { int j = 2; for (i = 3; i > -2; i--) {
		 * System.out.println("Try block entered"); System.out.print("i=" + i +
		 * " j=" + j + " " + j + "/" + i + "="); System.out.println(j / i);
		 * System.out.println("End of try block"); } } catch
		 * (ArithmeticException hiba) {
		 * System.out.println("Arithmetic exception thrown " + hiba); } finally
		 * { System.out.println("Finally block. Ez mindig lefut. Az i értéke: "
		 * + i); }
		 * 
		 * //Try block inside the for cycle - the cycle continues after the
		 * exception
		 * System.out.println("After catch block and first for cycle"); int j =
		 * 2; for (i = 3; i > -2; i--) { try {
		 * System.out.println("\nTry block entered"); System.out.print("i=" + i
		 * + " j=" + j + " " + j + "/" + i + "="); System.out.println(j / i);
		 * System.out.println("End of try block, goto next iteration"); //Nested
		 * catch block try { if (i == 1) {
		 * System.out.println("Nested catch block entered."); int hibaValtozo =
		 * (10 / (i - 1)); } } catch (Exception hiba) {
		 * System.out.println("Nested catch block hiba!" + hiba); } } catch
		 * (ArithmeticException hiba) {
		 * System.out.println("Arithmetic exception thrown " + hiba); } catch
		 * (ArrayIndexOutOfBoundsException | ArrayStoreException hiba) {
		 * System.out.println("Többféle hibát is kezel: " + hiba); } catch
		 * (IndexOutOfBoundsException hiba) {
		 * System.out.println("Out of bounds hiba" + hiba); } finally {
		 * System.out.println("Finally block. Ez mindig lefut. Az i értéke: " +
		 * i); }
		 * 
