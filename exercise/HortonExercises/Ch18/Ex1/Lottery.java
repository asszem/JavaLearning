 ...
 * 
 * */
package HortonExercises.Ch18.Ex1;
...
public class Lottery extends JApplet {
	...
	public void createGUI() {
		...
		for (int i = 0; i < NUMBER_COUNT; ++i) {
			...
			// Each NumberButton object has it's own action listener assigned
			luckyNumberButtons[i].addActionListener(luckyNumberButtons[i]);           // Button is it's own listener
			luckyNumberButtons[i].addMouseListener(new MouseHandler());
	...
	private class NumberButton extends JButton implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			int candidate = 0;
			int oldButtonValue = buttonValue; 		// Store original button value
