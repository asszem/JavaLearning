...
public class Ex2_Horton_SquareWindowWButtons extends JFrame {
  public Ex2_Horton_SquareWindowWButtons(String title) {
    super(title);
  ...
  public void addButtons() {
   ...
   public static void main(String[] args) {
    SwingUtilities.invokeLater(new Runnable() {
            public void run() {
              Ex2_Horton_SquareWindowWButtons myWindow = new Ex2_Horton_SquareWindowWButtons("Chapter 17 Exercise 1 - Look, I'm square...");
            }
        });
   }
}