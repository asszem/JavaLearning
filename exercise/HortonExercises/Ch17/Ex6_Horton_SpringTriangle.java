...
public class Ex6_Horton_SpringTriangle extends JFrame {
  public Ex6_Horton_SpringTriangle(String title) {
    super(title);
  ...
  public static void main(String[] args) {
    SwingUtilities.invokeLater(new Runnable() {
            public void run() {
              Ex6_Horton_SpringTriangle window = new Ex6_Horton_SpringTriangle("This is a Spring Layout");
            }
        });
  }
}