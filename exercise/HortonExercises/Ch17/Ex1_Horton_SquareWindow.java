...
public class Ex1_Horton_SquareWindow extends JFrame {
  public Ex1_Horton_SquareWindow(String title) {
    super(title);
   ...
   public static void main(String[] args) {
    SwingUtilities.invokeLater(new Runnable() {
            public void run() {
              Ex1_Horton_SquareWindow myWindow = new Ex1_Horton_SquareWindow("Chapter 17 Exercise 1 - Look, I'm square...");
            }
        });
   }
}